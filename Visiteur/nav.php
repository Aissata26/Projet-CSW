        ...
        <form class="justify-content-center"  method="POST" action="../fonction.php">
          ...
          <div class="mb-3 text-start">
            ...
            <select class="form-select" aria-label="Default select example" name="categorie">
              <option>---</option>
              <option <?php if(isset($_SESSION['categorie'])){if($_SESSION['categorie']==='1'){echo 'selected';}}?>>Client</option>
              <option <?php if(isset($_SESSION['categorie'])){if($_SESSION['categorie']==='2'){echo 'selected';}}?>>Déménageur</option>
            </select>
          </div>
          <div class="mb-3 text-start">
