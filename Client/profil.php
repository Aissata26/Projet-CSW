      ...
      <section class="rounded-4 shadow-sm overflow-hidden bg-light">
        <div class="px-4 py-3"
          ...
          <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div class="mb-2">
              <p class="mb-1 text-uppercase" style="font-size:0.7rem;letter-spacing:1px;opacity:0.8;">
                Profil Move<span class="titre-color">UP</span>
              </p>
              <h2 class="mb-0 fw-bold" style="font-size:1.5rem;">Aissata Diallo</h2>
              <p class="mb-1" style="font-size:0.9rem;opacity:0.9;">aissata@example.com</p>
            </div>
        ...
        <div class="px-4 py-4">
          <h6 class="mb-1">Informations personnelles</h6>
          <hr class="mt-2 mb-3">
          <div class="mb-3">
            <span class="text-muted small d-block">Nom complet</span>
            <span class="fw-semibold">Aissata Diallo</span>
          </div>
          <div class="mb-3">
          ...
          <a href="client.php" class="btn btn-link btn-sm p-0">
